...
def get_lowest_product_prices_from_sellers_page(response):
    sel = Selector(response)
    ...
    for offer_element in offer_elements:
        ...
        if track_message_element:
            ...
            if cannot_be_shipped_element:
                ...
                whole_price_text = whole_price_text.replace("¥", "")
                whole_price_text = whole_price_text.replace("$", "").strip()
                ...
                # Shipping
                shipping_price_element_texts = offer_element.xpath(".//*[@id='dynamicDeliveryMessage']//text()").extract()
                shipping_price_element_text = ' '.join([s.strip() for s in shipping_price_element_texts if s.strip()])
