...
class AmazonbotUsLocationSeleniumMiddleware(SeleniumMiddleware):
    def __init__(self, driver_name, driver_executable_path, driver_arguments,
        browser_executable_path):
        super().__init__(driver_name, driver_executable_path, driver_arguments,
        browser_executable_path)
        self._set_location_to_us()
    
    def _set_location_to_us(self):
        zipcode = "10001"
        ...
        while(True):
            ...
            if zipcode_inputs:
                zipcode_input = zipcode_inputs[0]
                if zipcode_input.is_displayed():
                    break
        for z in zipcode:
            zipcode_input.send_keys(z)
            time.sleep(0.500)
